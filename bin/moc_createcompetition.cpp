...
#include "../src/createcompetition.h"
...
QT_MOC_LITERAL(1, 18, 16), // "handleCreateComp"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "CreateCompetition\0handleCreateComp\0"
};
...
void CreateCompetition::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CreateCompetition *_t = static_cast<CreateCompetition *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->handleCreateComp(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject CreateCompetition::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CreateCompetition.data,
      qt_meta_data_CreateCompetition,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CreateCompetition::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CreateCompetition.stringdata0))
        return static_cast<void*>(const_cast< CreateCompetition*>(this));
